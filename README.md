...
The [multimedia essay assignment](https://printinginprisons.org/blog/aviles/) was another exercise of interacting with data through storytelling. I decided to write about American expansionism at ESP, specifically how these ideas were represented in The Umpire.  This essay taught me how to carefully craft a story by connecting the small amount of data I could find. Writing this piece was a challenge for me because it was my first time crafting an essay with so little information but I was pleased with the end result. I incorporated a picture of the article I analyzed but if I could revise it I would change how the picture fits into the website and add more images to enhance the visual appeal of the webpage. Overall, I would focus on better integrating the media elements into the design. I think all I need is more practice with coding using mardown syntax and learning all the ways an image can be coded into the page. Aside from storytelling, I also learned how to do archival research. As practice, we were tasked with creating the metadata for specific articles in Reformatory Records. In the end we had a massive [spreadsheet](https://docs.google.com/spreadsheets/d/1bnEvYe_KdwORTZ8Mto2lk6d_GJ--EIxUUJB60C7f8qE/edit?usp=sharing) with hundreds of described articles. For my essay, I had to scour the internet for a newspaper called Boston Evening Transcript. I was unable to find the specific issue I wanted but I learned how to use the clues of the dates given in my article to deduce when the newspaper could have been printed. 

Outside of class, we were required to attend two workshops. I went to a woodworking one in West Philly. Perosnally, don't think it related a lot to this digital humanities class since I was working physical objects, however, it served its purpose in getting me interested in woodwroking. The second workshop I attended was about coding and board games. The purpose was to draw parallels between the two. This relates more to the class since we had been working on coding for the multimedia essay. 

Reflecting on the entire class, I noticed some clear themes and patterns. One recurring topic was the ethical considerations of working with data, regarding the way it's represented and its accuracy. From metadata, crafting stories and digitizing archives, we returned to the question of who controlled the narrative and with what purpose. Digital humanities is much more than I expected. Another theme I encountered  was the relationship between history and technology. No just using technology to record history but the history of technology itself. For example, not only did we learn how to work in HTML and markdown syntax, but we also learned about the history behind it.
